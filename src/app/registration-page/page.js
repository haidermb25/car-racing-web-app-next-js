        ...
        <div className="max-w-[98%] mx-auto">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex w-full border-2 border-black">
                  ...
                  <div className="w-20 flex items-center justify-center bg-gray-200 text-2xl font-bold text-black border-l-2 border-black">
                    lb
                  </div>
                </div>

                <p className="text-sm text-black mt-2">
                  (Including helmet, suit, gloves, ect)
                </p>
                </div>
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-[20%] bg-[#60A5FA] text-black uppercase font-extrabold text-xl sm:text-2xl py-4 px-6 hover:opacity-90 transition-opacity cursor-pointer"
              >
                CONTINUE
              </button>
            </div>
